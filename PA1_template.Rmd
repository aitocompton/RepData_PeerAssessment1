...
The mean and median total number of steps derived from aggSteps2 differ from the mean and median total number of steps derived from  aggSteps. The imputing missing data on the total steps increased the mean, `r round(mean(aggSteps$steps),2)`, and median, `r median(aggSteps$steps)`, of the daily steps of aggSteps (the dataset without the imputation). 
